...
namespace CarServiceApp
{
    public partial class AddOrderForm : Form
    {
        ...
        public AddOrderForm(Dictionary<int, string> cars, Dictionary<int, string> clients, Dictionary<int, string> services, Dictionary<int, string> masters)
        {
            InitializeComponent();
            _cars = cars;
            _clients = clients;
        ...
        private void acceptBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                addQuery.AddRepair(carId, clientId, serviceId, masterId, Convert.ToInt32(count_NUD.Value), cost_NUD.Value);
